...
<xsl:stylesheet xmlns="http://www.w3.org/1999/xhtml"
    ...
    xmlns:skos="http://www.w3.org/2004/02/skos/core#" version="2.0" exclude-result-prefixes="xsl tei xs">
        ...
        <html lang="de">
            <head>
                <xsl:call-template name="html_head">
                    <xsl:with-param name="html_title" select="'Karl Kraus Rechtsakten - Zeitstrahl'"/>
                </xsl:call-template>
                <style>
                    .highcharts-yaxis,
