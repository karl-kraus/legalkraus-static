                    ...
                    <div class="container">
                        ...
                        <div class="row row-cols-1 row-cols-md-5 justify-content-between border-bottom border-primary border-8 pb-5">
                                ...
                                <div class="card rounded-0 border-0 d-block w-8r pt-3">
                                    <div class="card-body p-0">
                                        <p class="card-title fw-bolder">
                                            <a href="oskar-samek.html" class="stretched-link" alt="...">Oskar Samek</a>
                                        </p>
                                    </div>
                            ...
                            <div class="col-md-auto justify-content-center d-flex px-md-0">
                                <div class="card rounded-0 border-0  d-block w-8r pt-3">
                                    <div class="card-body p-0">
                                        <p class="card-title fw-bolder">
                                            <a href="fallstatistik.html" class="stretched-link" alt="link zur fallstatistik">Fallstatistik</a>
                                        </p>
                                    </div>
                            ...
                            <div class="col-md-auto justify-content-center d-flex px-md-0">
                                <div class="card rounded-0 border-0 d-block w-8r pt-3">
                                    <div class="card-body p-0">
                                        <p class="card-title fw-bolder">
                                            <a href="beitraege.html" class="stretched-link" alt="...">Beiträge</a>
                                        </p>
                                    </div>
                            ...
                            <div class="col-md-auto justify-content-center d-flex px-md-0">
                                <div class="card rounded-0 border-0 d-block w-8r pt-3">
                                    <div class="card-body p-0">
                                        <p class="card-title fw-bolder">
                                            <a href="verlage-collections.html" class="stretched-link" alt="...">Verlage</a>
                                        </p>
                                    </div>
                            ...
                            <div class="col-md-auto justify-content-center d-flex px-md-0">
                                <div class="card rounded-0 border-0 d-block w-8r pt-3">
                                    <div class="card-body p-0">
                                        <p class="card-title fw-bolder">
                                            <a href="sozialdemokratie-collections.html" class="stretched-link">Sozialdemokratie</a>
                                        </p>
                                    </div>
                        ...
                        <div>
                            <div class="mt-3 text-left">
                                <p>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="var(--bs-primary)" class="bi bi-arrow-right me-2" viewBox="0 0 16 16">
                                        <path fill-rule="evenodd" d="M1 8a.5.5 0 0 1 .5-.5h11.793l-3.147-3.146a.5.5 0 0 1 .708-.708l4 4a.5.5 0 0 1 0 .708l-4 4a.5.5 0 0 1-.708-.708L13.293 8.5H1.5A.5.5 0 0 1 1 8z"/>
                                    </svg>
                                    <span class="align-text-top fw-bolder">700 Vorlesungen von Karl Kraus</span>
                                </p>
                                <p class="w-75 small">
                                    <i>Rechtsakten Karl Kraus</i> baut auf <i>Karl Kraus Online</i>, einem Kooperationsprojekt der Wienbibliothek im Rathaus mit dem ehemaligen Ludwig Boltzmann Institut für Geschichte und Theorie der Biografie (2005–2018), auf. Der Rechtsaktenbestand wurde zu der hier vorliegenden Edition aufbereitet und überschrieb somit die ältere Fassung. Die 700 Vorlesungen hingegen liegen noch in der alten Version vor und sind hier zu finden:</p>
                                <p>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="var(--bs-primary)" class="bi bi-box-arrow-right me-1" viewBox="0 0 16 16">
