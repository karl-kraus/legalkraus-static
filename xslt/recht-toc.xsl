...
<xsl:stylesheet 
    ...
    <xsl:param name="legalTopic"/>
    <xsl:template match="/">
        
        <xsl:variable name="topic">
            <xsl:choose>
                <xsl:when test="$legalTopic">
                    <xsl:value-of select="$legalTopic"/>
                </xsl:when>
                <xsl:otherwise>
                    <xsl:value-of select="''"/>
                </xsl:otherwise>
        ...
        <xsl:variable name="doc_title" select="$topic"/>
                    ...
                    <div class="container-fluid">
                        <div class="card rounded-0">
                            <div class="card-header bg-darker-gray rounded-0">
                                <h1 class="text-center"><xsl:value-of select="$legalTopic"/></h1>
                            </div>
                            <div class="card-body">
                                <table class="table table-striped display" id="tocTable" style="width:100%">
                                    ...
                                    <tbody>
                                        <xsl:for-each select="collection('../data/cases_tei?select=*.xml')//tei:TEI[.//tei:term[./text() eq $legalTopic]]">
